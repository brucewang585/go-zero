...
```shell
go get -u github.com/brucewang585/go-zero
```
...
0. full examples can be checked out from below:
     ...
     [Rapid development of microservice systems](https://github.com/brucewang585/zero-doc/blob/main/doc/shorturl-en.md)

     [Rapid development of microservice systems - multiple RPCs](https://github.com/brucewang585/zero-doc/blob/main/doc/bookstore-en.md)
...
1. install goctl
   ...
   ```shell
   GO111MODULE=on go get -u github.com/brucewang585/go-zero/tools/goctl
   ```
