...
import (
	...
	"github.com/brucewang585/go-zero/example/graceful/etcd/api/svc"
	"github.com/brucewang585/go-zero/example/graceful/etcd/api/types"
	"github.com/brucewang585/go-zero/example/graceful/etcd/rpc/graceful"
